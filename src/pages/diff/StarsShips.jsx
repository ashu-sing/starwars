...
const Starships = () => {
  ...
  const { data, status } = useQuery("starships", fetchStarshipsData, {
    onSuccess: () => console.log("Starships data fetched"),
  ...
  return (
    <>
      ...
      <div className="py-3 m-10">
        <h3 className="font-semibold text-lg">Starships</h3>
        {activeButton === "List" && (
                    ...
                    >
                      ...
                      <div className="hidden sm:flex sm:flex-col sm:items-end">
                        ...
                        <p className="mt-1 text-xs leading-5 text-slate-100">
                          <time dateTime={starship.model}>{starship.model}</time>
                        </p>
                      </div>
                    </li>
                  ))
        ...
        {activeButton === "Grid" && (
          <div className="bg-transparent Grids">
            <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
              <h2 className="sr-only">Starships</h2>
              <div className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 xl:gap-x-8">
                {status === "loading" ? (
                  ...
                  Array.isArray(data?.results) ? (
                    data.results.map((starship) => (
                      <a key={starship.name} className="group">
